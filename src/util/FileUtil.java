...
/**
 * Represents multiple methods for handling both internal and external files.
 * @author Finn Frankis
 * @version Aug 3, 2018
 */
...
{
    /**
     * Converts the contents of a given external file (stored in a directory not linked to the project)
    ...
    /**
     * Converts the contents of a given local file (stored in a project directory past src).
     * into a String format.
     * @param fileName the name of the file to be converted
     * @return the String format of the given file
     * @throws Exception if the file cannot be found or read from
